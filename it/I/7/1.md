...
In questo caso più generale la formula della funzione di produzione
...
generale, bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla.
bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla bla 
<p>
<span style="color: Blue;">
\(\begin{gathered}
 L = \frac{1}{\alpha} Q^2 + \frac{1}{\beta} Q
\end{gathered}\)
</span>
</p>
