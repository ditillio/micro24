...
Notiamo infine che se $\alpha=1$ allora il prodotto marginale è costante e coincide con il prodotto medio: $MP_L=A$. Illustriamo il caso $\alpha=1$ nella figura qui sotto. Cosa succederebbe, infatti, se nella vostra carriera scolastica il voto che ottenete in ogni verifica fosse sempre lo stesso, per esempio 9? Quale sarebbe la vostra media?
